...
#import and structure clustered data (all features)
...
#save descriptive data about all features #change format
all_features_summary.to_csv('./clustering_and_scaling_data/all_features_cluster_summary')

#save descriptive data about two features #change format
